...
// Sets default values
AMyServerPortalActorParallelGrou::AMyServerPortalActorParallelGrou(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	GetStaticMeshComponent()->SetWorldScale3D(FVector(0.5f, 1.0f, 1.0f));
	...
	_displayText->SetTextRenderColor(FColor::Green);
