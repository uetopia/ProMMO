...
// Sets default values
AMyServerPortalActorParallelPriv::AMyServerPortalActorParallelPriv(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	_displayText->SetTextRenderColor(FColor::White);
